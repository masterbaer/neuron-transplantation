...
def get_parser():
    ...
    # for simplenet
    parser.add_argument('--num-hidden-nodes', default=400, type=int,
                        help='simplenet: number of hidden nodes in the only hidden layer')
    # for mlpnet
    ...
    parser.add_argument('--skip-last-layer', action='store_true',
                        help='skip the last layer in calculating optimal transport')
    ...
    parser.add_argument('--softmax-temperature', default=1, type=float,
                        help='softmax temperature for activation weights (default: 1)')
    ...
    parser.add_argument('--options-type', type=str, default='generic', choices=['generic'],
                        help='the type of options to load')
    ...
    parser.add_argument('--save-result-file', type=str, default='default.csv',
                        help='path of csv file to save things to')
    ...
    parser.add_argument('--retrain', type=int, default=0, action='store',
    ...
    parser.add_argument('--load-models', type=str, default='',
                        help='path/name of directory from where to load the models')
    parser.add_argument('--ckpt-type', type=str, default='best', choices=['best', 'final'],
                        help='which checkpoint to load')

    parser.add_argument('--recheck-cifar', action='store_true', help='recheck cifar accuracies')
    parser.add_argument('--recheck-acc', action='store_true',
                        help='recheck model accuracies (recheck-cifar is legacy/deprecated)')
    ...
    parser.add_argument('--activation-seed', type=int, default=42, action='store',
                        help='seed for computing activations')
    ...
    parser.add_argument('--prediction-wts', action='store_true',
                        help='use wts given by ensemble step for prediction ensembling')
    ...
    parser.add_argument('--proper-marginals', action='store_true',
                        help='consider the marginals of transport map properly')
    ...
    parser.add_argument('--skip-retrain', type=int, default=-1, action='store',
                        help='which of the original models to skip retraining')
    ...
    parser.add_argument('--handle-skips', action='store_true',
                        help='handle shortcut skips in resnet which decrease dimension')
    return parser
